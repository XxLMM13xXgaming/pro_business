...
--			ViewAppsP:SetSize(300, 20)
	...
	local function showbeditpage()
		...
		InfoText:SetPos(20, 60)
		InfoText:SetSize(DFrame:GetWide() - 40, DFrame:GetTall() - 70)
		InfoText:SetText("On this page you can edit your business basics!")
		InfoText:SetContentAlignment(7)
		InfoText:SetWrap(true)
		InfoText:SetFont("DermaLarge")
		...
		local TheBusinessType = vgui.Create("DLabel", DFrame)
		TheBusinessType:SetPos(20, 150)
		TheBusinessType:SetText("Business Type: " .. self:GetPBusinessType())
		TheBusinessType:SetFont("DermaLarge")
		timer.Simple(.1,function()
			TheBusinessType:SizeToContents()
			local editbnameMat = Material("icon16/brick_edit.png")
			local EditTBtn = vgui.Create( "DButton", DFrame )
			EditTBtn:SetPos( TheBusinessType:GetWide() + 30, 160 )
			EditTBtn:SetSize( 16, 16 )
			EditTBtn:SetText("")
			EditTBtn.Paint = function( s, w, h )
				surface.SetMaterial( editbnameMat )
				surface.SetDrawColor( color_white )
				surface.DrawTexturedRect( 0, 0, w, h )
			end
			EditTBtn.DoClick = function()
				Derma_Query( "What would you like your business type to be?", "PB Business Type Change ", "Sales", function()
					net.Start("PBusinessTypeChangeToSales")
					net.SendToServer()
					TheBusinessType:SetText("Business Type: Sales")
					TheBusinessName:SizeToContents()
					EditTBtn:SetPos( TheBusinessType:GetWide() + 30, 160 )
				end, "Service", function()
					net.Start("PBusinessTypeChangeToService")
					net.SendToServer()
					TheBusinessType:SetText("Business Type: Service")
					TheBusinessName:SizeToContents()
					EditTBtn:SetPos( TheBusinessType:GetWide() + 30, 160 )
				end, "Close", function()
				end)
